(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_5054b8._.js", {
...
function Dashboard() {
    _s();
    const { stats, updateStats } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$dashboard$2d$context$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboard"])();
            ...
            const fetchStats = {
                "Dashboard.useEffect.fetchStats": async ()=>{
                    try {
                        ...
                        const productsResponse = await fetch("http://localhost:8001/allproducts", {
                            method: "GET",
                            credentials: "include"
                        });
                        // Fetch team count
                        const teamResponse = await fetch("http://localhost:8001/allteams", {
                            method: "GET",
                            credentials: "include"
                        });
                        // Fetch reviews count
                        const reviewsResponse = await fetch("http://localhost:8001/allreviews", {
                            method: "GET",
                            credentials: "include"
                        });
                        // Fetch orders count (if available)
                        const ordersResponse = await fetch("http://localhost:8001/allorders", {
                            method: "GET",
                            credentials: "include"
                        }).catch({
                        ...
                        if (ordersResponse.ok) {
                            ...
                            // If orders API is not available, use placeholder data
                            updateStats({
                                orders: 0,
                                revenue: 0
                            });
...
_s(Dashboard, "pus71gG4q2nO6VnY2NJz6f/o1+U=", false, function() {
    return [
...
"[project]/src/app/dashboard/reviews/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$page$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/dashboard/page.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$star$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Star$3e$__ = __turbopack_import__("[project]/node_modules/lucide-react/dist/esm/icons/star.js [app-client] (ecmascript) <export default as Star>");
...
function ReviewsPage() {
    ...
    const filteredReviews = reviews.filter((review)=>review.name.toLowerCase().includes(searchTerm.toLowerCase()) || review.review.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    const renderStars = (rating)=>{
        ...
        for(let i = 0; i < 5; i++){
            stars.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$star$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Star$3e$__["Star"], {
                ...
                fileName: "[project]/src/app/dashboard/reviews/page.jsx",
                lineNumber: 82,
                columnNumber: 9
            }, this));
        }
...
_s(ReviewsPage, "ZS46TNaH/kF5MT/ZvxmNShuDddU=");
_c = ReviewsPage;
var _c;
__turbopack_refresh__.register(_c, "ReviewsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/dashboard/reviews/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_5054b8._.js.map