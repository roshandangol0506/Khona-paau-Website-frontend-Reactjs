(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9b1cfc._.js", {
...
function Dashboard() {
                ...
                "Dashboard.useEffect.fetchStats": async ()=>{
                    try {
                        ...
                        if (teamResponse.ok) {
                            ...
                            console.log("teamData", teamData.data?.length);
                            updateStats({
                                team: teamData.data?.length || 5
                            });
                        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            console.log("Updated stats", stats.team);
        }
    }["Dashboard.useEffect"], [
        stats.team
    ]);
...
_s(Dashboard, "tJO+ZRvnIaL6t8Px2+m57Uhnkso=", false, function() {
    return [
...
//# sourceMappingURL=_9b1cfc._.js.map