(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_4f88ae._.js", {
            ...
            const fetchMycart = {
                "CartProvider.useEffect.fetchMycart": async ()=>{
                    try {
                        ...
                        setmycart(response.data.mycart || []); // Ensure it sets an array
                    } catch (error) {
                        setError("No Cart items found.");
                    } finally{
                        setIsLoaded(true); // Ensure this runs even if there's an error
                    }
                }
...
_s(Navbar, "j4vdH1qQ7/9GsoX/NA/tL1MBjT8=", false, function() {
    return [
...
//# sourceMappingURL=src_4f88ae._.js.map