(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_ccd86a._.js", {
...
const NumberInput = ({ baseAmount, onTotalChange })=>{
    ...
    const handleValueChange = (newValue)=>{
        ...
        setValue(newValue);
        onTotalChange(total, newValue); // Pass quantity too
    };
...
const MyCart = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyCart.useEffect": ()=>{
            const fetchReview = {
                "MyCart.useEffect.fetchReview": async ()=>{
                    try {
    ...
    const handleCheckboxChange = (serviceId, baseAmount)=>(event)=>{
            setSelectedItems((prev)=>{
                ...
                if (event.target.checked) {
                    const existingQuantity = itemQuantities[serviceId] || 1; // Get existing quantity or default to 1
                    newSelectedItems[serviceId] = baseAmount * existingQuantity; // Use correct quantity
    ...
    const handleCheckout = ()=>{
        ...
        console.log("Selected Data for Checkout:", selectedData);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
...
_s(MyCart, "wTt6dnYQJVeWM/ecqjHGC75Y02A=", false, function() {
    return [
...
//# sourceMappingURL=src_ccd86a._.js.map