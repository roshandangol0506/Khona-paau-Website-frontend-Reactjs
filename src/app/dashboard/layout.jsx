...
import { Package, Users, Star, LayoutDashboard, Settings, Menu, X } from "lucide-react"
        ...
        >
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-base font-medium text-gray-700">{user?.username || "User"}</p>
                <p className="text-sm font-medium text-gray-500 truncate">{user?.email || "user@example.com"}</p>
              </div>
            </div>
          </div>
        </div>
